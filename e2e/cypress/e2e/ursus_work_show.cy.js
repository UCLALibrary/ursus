...
describe('Work show pages', () => {
  it('Arganon (Praise) of Mary', () => {
    const viewerIframeSelector = 'iframe[src*="p-w-dl-viewer01.library.ucla.edu"]';
    ...
    cy.frameLoaded(viewerIframeSelector, {
      url:
    ...
    cy.iframe(viewerIframeSelector).contains('div', 'Ms. 35 Arganon');
  });
});
