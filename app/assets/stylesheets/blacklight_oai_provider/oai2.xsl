...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    ...
    the <a href="#moreinfo">bottom of the page</a>. 
        </p>
    ...
    Safari, and Internet Explorer. The XSLT file was created by <a href="http://www.ecs.soton.ac.uk/people/cjg">Christopher Gutteridge</a> at the
    University of Southampton as part of the <a href="http://www.eprints.org/uk/index.php/eprints-software/">GNU EPrints system</a>, and
    is freely redistributable under the <a href="http://www.gnu.org">GPL</a>. 
        </p>
        <p>For more information or to download the XSL file please see the <a href="http://wiki.eprints.org/w/EPrints_OAI_Stylesheet">OAI to XHTML XSLT homepage</a>. 
        </p>
      </body>
    </html>
  </xsl:template>
  ...
  <xsl:template name="quicklinks">
    <ul class="quicklinks">
      ...
      <li>
        <a href="?verb=ListRecords&amp;metadataPrefix=oai_dpla">ListRecords</a> | 
      </li>
      <li>
  ...
  <xsl:template match="/oai:OAI-PMH">
    ...
    errors.</p>
      ...
      <xsl:otherwise>
        <p>Request was of type <xsl:value-of select="$verb" />
 .</p>
        <div class="results">
  ...
  <xsl:template match="oai:ListMetadataFormats">
    <xsl:choose>
      <xsl:when test="$identifier">
        <p>This is a list of metadata formats available for the record "<xsl:value-of select='$identifier' />
 ". Use these links to view the metadata: <xsl:apply-templates select="oai:metadataFormat/oai:metadataPrefix" />
      </p>
    </xsl:when>
    <xsl:otherwise>
  ...
  <table class="values">
    <tr>
      ...
      <td class="value">
        ...
        <xsl:text></xsl:text>
        <a class="link" href="?verb=GetRecord&amp;metadataPrefix=oai_dpla&amp;identifier={oai:identifier}">
    oai_dpla</a>
        <xsl:text></xsl:text>
        ...
        <xsl:if test="oai:setSpec = 'oai_set_ssim:arce'">
          <a class="link" href="?verb=GetRecord&amp;metadataPrefix=mods_arce&amp;identifier={oai:identifier}">
    mods_arce</a>
        </xsl:if>
        <xsl:text></xsl:text>
