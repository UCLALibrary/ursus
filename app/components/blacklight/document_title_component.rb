...
module Blacklight
  class DocumentTitleComponent < Blacklight::Component
    ...
    def initialize(title = nil, document: nil, presenter: nil, as: :h3, counter: nil, classes: 'document__list-title document__list-title--ursus', link_to_document: true, document_component: nil, actions: true)
    ...
    def title
      if @link_to_document
        helpers.link_to_document presenter.document, @title.presence || content.presence, itemprop: 'name'
      else
