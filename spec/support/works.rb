...
FIRST_WORK = {
  ...
  sort_title_tsort: 'The Title 1 of my Work',
...
SECOND_WORK = {
  ...
  sort_title_tsort: 'The Title 2 of my Work',
...
THIRD_WORK = {
  ...
  sort_title_tsort: 'The Title 10 of my Work',
...
FOURTH_WORK = {
  ...
  sort_title_tsort: 'The Title 100 of my Work',
  identifier_tesim: ['ark 456'],
  description_tesim: ['Description 3', 'Description 4', 'another desc'],
  date_created_tesim: ["Date 1"],
  sort_year_isi: 1929,
