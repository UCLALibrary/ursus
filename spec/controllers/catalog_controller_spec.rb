  ...
  describe "show fields" do
    ...
    let(:expected_show_fields) do
      ["architect_tesim", "alternative_title_tesim", "ark_ssi", "author_tesim",
       ...
       'format_book_tesim', 'resp_statement_tesim', 'citation_source_tesim',
       'related_to_ssm', 'human_readable_related_record_title_ssm',
       "oai_set_ssim", "edition_ssm", "history_tesim", "identifier_global_tesim"]
    end
