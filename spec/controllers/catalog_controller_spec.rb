  ...
  describe "show fields" do
    ...
    let(:expected_show_fields) do
      ["architect_tesim", "alternative_title_tesim", "ark_ssi", "author_tesim",
       ...
       "engraver_tesim", "extent_tesim", "features_tesim",
       ...
       "iiif_manifest_url_ssi", "illustrations_note_tesim", "keyword_tesim", "latitude_tesim",
