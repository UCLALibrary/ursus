  ...
  describe "show fields" do
    ...
    let(:expected_show_fields) do
      ["architect_tesim", "alternative_title_tesim", "ark_ssi", "author_tesim",
       ...
       "geographic_coordinates_ssim", "human_readable_resource_type_tesim", "human_readable_rights_statement_tesim",
       ...
       "hand_note_sim", "writing_system_tesim", "commentator_tesim", "translator_tesim",
       "license_tesim", "normalized_date_sim", "subject_geographic_tesim", "subject_temporal_tesim",
       "associated_name_tesim", "delivery_tesim", "descriptive_title_tesim", "form_tesim", "image_count_tesim", "references_tesim", "shelfmark_tesim"]
    end
