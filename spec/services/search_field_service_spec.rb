...
RSpec.describe SearchFieldService do
  ...
  it 'returns the correct list of search fields' do
    expect(search_field_service.search_fields).to eq(%w[ alternative_title_tesim architect_tesim caption_tesim binding_note_ssi
                                                         ...
                                                         page_layout_ssim photographer_tesim place_of_origin_tesim publisher_tesim subject_tesim subject_topic_tesim summary_tesim title_tesim uniform_title_tesim ark_ssi ].join(' '))
  end
end
