...
module Ucla::Blacklight::Dpla
  ...
  def export_as_oai_dpla_xml
    ...
    xml = build_xml_tag(xml)
    xml.target!
  end

  alias to_oai_dpla export_as_oai_dpla_xml
  alias export_as_xml export_as_oai_dpla_xml
  alias export_as_dpla_xml export_as_oai_dpla_xml

  private

    def build_xml_tag(xml)
